...
class TinyPad:
    ...
    def __init__(self, **kwargs):
        ...
        self.__thisHelpMenu.add_command(label="About TinyPad", command=self.__showAbout)
    ...
    def __showAbout(self):
        showinfo("Notepad", "A tiny pad by Soumodip")
    ...
    def __openFile(self):
        ...
        if self.__file == "":
            ...
            self.__root.title(os.path.basename(self.__file) + " - TinyPad")
...
notepad = TinyPad(width=600, height=400)
notepad.run()